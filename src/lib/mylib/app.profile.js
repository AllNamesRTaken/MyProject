...
function copyOnly(mid) {
    return mid in {
        ...
        // them here like this:
        'src/lib/modernizr/modernizr-2.0.6.min.js': 1
    };
}
...
var profile = {
	...
	packages: [
		{
			...
			destLocation: 'lib/dojotoolkit/dojo'
		},
		{
			name: 'dijit',
			location: 'dojotoolkit/dijit',
			destLocation: 'lib/dojotoolkit/dijit'
		},
		{
			name: 'dojox',
			location: 'dojotoolkit/dojox',
			destLocation: 'lib/dojotoolkit/dojox'
		},
		{
			name: 'mylib',
			location: 'mylib',
    ...
    /*layers: {
        ...
        'wi/run': { 
			include: [ 'wi/run', 'wi/main', 'soyamilk'],
			dependencies: [ 'dojo/has' ]
			//, 'wi/app/module', 'wi/framework/module', 'wi/core/module', 'wi/services/module', 'wi/modules/module' ]
		}
    },*/
    ...
    resourceTags: {
        ...
        copyOnly: function (filename, mid) {
            return copyOnly(mid || filename.substring(filename.lastIndexOf('/src/')+1));
        },
        ...
        miniExclude: function (filename, mid) {
			if (mid && mid.indexOf("/tests")>-1) return true;
			if (filename && filename.substr(-7) === ".coffee") return true;
            return mid in {
                'app/profile': 1
            };
        }
